    ...
    public void receiveInteraction(int interactionClass, ReceivedInteraction theInteraction, byte[] tag, LogicalTime theTime, EventRetractionHandle eventRetractionHandle) throws InteractionClassNotKnown, InteractionParameterNotKnown, InvalidFederationTime, FederateInternalError {
        ...
        try {
            if (interactionClass == wejscieDoPrzychodniHandle) {
                ...
                StatystykaAmbassador.listaPacjentow.EnterToWaitingRoom(id_pacjenta,convertTime(theTime));
                ...
                StatystykaAmbassador.listaPacjentow.EnterToConsultingRoom(id_pacjenta,convertTime(theTime));
                ...
                StatystykaAmbassador.listaPacjentow.LeavesClinic(id_pacjenta,convertTime(theTime));
